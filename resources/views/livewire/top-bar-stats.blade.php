<div wire:init='getCurrentCoinInfo'>
    @if($isLoadingStats)
    ...
    @else
        <div class="flex items-center">
            <span class="w-8 mr-2 h-8 flex items-center rounded-full justify-center bg-black">
                <svg class="fill-current text-white w-5 h-5" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 193 193" style="enable-background:new 0 0 193 193;" xml:space="preserve">
            ...
            <span class="font-bold">Helium <span class="ml-1 text-gray-400 font-normal">HNT</span><span class="ml-2 text-black font-bold">£{{ $heliumPrice }}</span></span>
        </div>
    @endif
</div>
