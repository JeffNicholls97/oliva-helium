<div class="flex-grow h-full">
    <div class="flex mb-5 justify-between items-center">
        <div class="flex w-1/2 items-center gap-3">
            <select wire:model="returnDate" class="w-52 w-full rounded-md border border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
    ...
    <div class="w-full flex flex-col">
        ...
        <div  wire:sortable="updateAccountOrder" wire:sortable.options="{ animation: 200 }" class="w-full h-full overflow-y-auto">
            @foreach ($accounts as $account)
                <div wire:sortable.item="{{ $account->id }}" wire:key="task-{{ $account->id }}" class="table-body even:bg-gray-50 gap-10 table-header grid grid-cols-12 w-full rounded-lg p-3">
                        ...
                        <form wire:submit.prevent='saveAccountData' class="flex flex-col" action="">
                            ...
                            <div class="w-full gap-5 flex items-center justify-center">
                                ...
                                <label class="w-full h-32 flex flex-col items-center justify-center px-4 py-6 bg-white text-blue rounded-lg border border-blue cursor-pointer hover:bg-gray-100 hover:text-black">
                                    ...
                                    <input wire:key="editImage" type='file' wire:model="profilePictureEdit" class="hidden" />
                                </label>
                            </div>
                            <div class="flex mt-10 relative items-center gap-5">
                                <div class="w-1/2">
                                    <input wire:key="editFirstName" id="first-name" placeholder="First Name" class="peer h-10 w-full border-b border-gray-200 text-gray-900 placeholder-transparent focus:outline-none focus:border-rose-600" wire:model.defer="firstName" type="text">
                                ...
                                <div class="w-1/2 relative">
                                    <input wire:key="editLastName" id="last-name" placeholder="Last Name" class="peer h-10 w-full border-b border-gray-200 text-gray-900 placeholder-transparent focus:outline-none focus:border-rose-600" wire:model.defer="lastName" type="text">
                            ...
                            <div class="flex mt-5 items-center relative w-full">
                                <div class="w-full relative">
                                    <input wire:key="editEmail" id="email" placeholder="Email Address" class="peer h-10 w-full border-b border-gray-200 text-gray-900 placeholder-transparent focus:outline-none focus:border-rose-600" wire:model.defer="emailAddress" type="text">
                            ...
                            <div class="flex mt-5 items-center relative w-full">
                                <div class="w-full relative">
                                    <input wire:key="editAccountKey" id="key" placeholder="Account Key" class="peer h-10 w-full border-b border-gray-200 text-gray-900 placeholder-transparent focus:outline-none focus:border-rose-600" wire:model.defer="accountKey" type="text">
                            ...
                            <div class="flex mt-5 items-center relative w-full">
                                <div class="w-full relative">
                                    <textarea wire:key="editAddress" placeholder="Enter Account Address" class="border focus:border-rose-600 focus:outline-none p-3 rounded-md w-full border-gray-200" wire:model.defer="address"></textarea>
                                </div>
                            </div>
                            <div class="flex mt-5 items-center relative w-full">
                                <div class="w-full relative">
                                    <ul class="grid gap-6 w-full md:grid-cols-4">
                                        <li class="col-span-2">
                                            <input wire:key="editCashTrue" type="radio" wire:model.lazy="cash" id="react-option-1" value="1" class="hidden peer">
                                        ...
                                        <li class="col-span-2">
                                            <input wire:key="editCashFalse" type="radio" wire:model.lazy="cash" id="flowbite-option-1" value="0" class="hidden peer">
