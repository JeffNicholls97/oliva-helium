...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PresetPlugin": () => (/* binding */ s)
/* harmony export */ });
/* harmony import */ var _easepick_datetime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @easepick/datetime */ "./node_modules/@easepick/datetime/dist/index.esm.js");
...
class s extends _easepick_base_plugin__WEBPACK_IMPORTED_MODULE_1__.BasePlugin{dependencies=["RangePlugin"];binds={onView:this.onView.bind(this),onClick:this.onClick.bind(this)};options={customLabels:["Today","Yesterday","Last 7 Days","Last 30 Days","This Month","Last Month"],customPreset:{},position:"left"};getName(){return"PresetPlugin"}onAttach(){if(!Object.keys(this.options.customPreset).length){const e=new _easepick_datetime__WEBPACK_IMPORTED_MODULE_0__.DateTime,s=()=>{const s=e.clone();s.setDate(1);const i=new Date(e.getFullYear(),e.getMonth()+1,0);return[new _easepick_datetime__WEBPACK_IMPORTED_MODULE_0__.DateTime(s),new _easepick_datetime__WEBPACK_IMPORTED_MODULE_0__.DateTime(i)]},i=()=>{const s=e.clone();s.setMonth(s.getMonth()-1),s.setDate(1);const i=new Date(e.getFullYear(),e.getMonth(),0);return[new _easepick_datetime__WEBPACK_IMPORTED_MODULE_0__.DateTime(s),new _easepick_datetime__WEBPACK_IMPORTED_MODULE_0__.DateTime(i)]},n=[[e.clone(),e.clone()],[e.clone().subtract(1,"day"),e.clone().subtract(1,"day")],[e.clone().subtract(6,"day"),e.clone()],[e.clone().subtract(29,"day"),e.clone()],s(),i()];Object.values(this.options.customLabels).forEach(((t,e)=>{this.options.customPreset[t]=n[e]}))}this.picker.on("view",this.binds.onView),this.picker.on("click",this.binds.onClick)}onDetach(){this.picker.off("view",this.binds.onView),this.picker.off("click",this.binds.onClick)}onView(t){const{view:e,target:s}=t.detail;if("Main"===e){const t=document.createElement("div");t.className="preset-plugin-container",Object.keys(this.options.customPreset).forEach((e=>{if(Object.prototype.hasOwnProperty.call(this.options.customPreset,e)){const s=this.options.customPreset[e],i=document.createElement("button");i.className="preset-button unit",i.innerHTML=e,i.dataset.start=s[0].getTime(),i.dataset.end=s[1].getTime(),t.appendChild(i),this.picker.trigger("view",{view:"PresetPluginButton",target:i})}})),s.appendChild(t),s.classList.add(`preset-${this.options.position}`),this.picker.trigger("view",{view:"PresetPluginContainer",target:t})}}onClick(e){const s=e.target;if(s instanceof HTMLElement){const e=s.closest(".unit");if(!(e instanceof HTMLElement))return;if(this.isPresetButton(e)){const s=new _easepick_datetime__WEBPACK_IMPORTED_MODULE_0__.DateTime(Number(e.dataset.start)),i=new _easepick_datetime__WEBPACK_IMPORTED_MODULE_0__.DateTime(Number(e.dataset.end));this.picker.options.autoApply?(this.picker.setDateRange(s,i),this.picker.trigger("select",{start:this.picker.getStartDate(),end:this.picker.getEndDate()}),this.picker.hide()):(this.picker.datePicked=[s,i],this.picker.renderAll())}}}isPresetButton(t){return t.classList.contains("preset-button")}}
...
/* harmony import */ var _easepick_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @easepick/core */ "./node_modules/@easepick/core/dist/index.esm.js");
/* harmony import */ var _easepick_range_plugin__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @easepick/range-plugin */ "./node_modules/@easepick/range-plugin/dist/index.esm.js");
/* harmony import */ var _easepick_preset_plugin__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @easepick/preset-plugin */ "./node_modules/@easepick/preset-plugin/dist/index.esm.js");
...
window.easepick = _easepick_core__WEBPACK_IMPORTED_MODULE_3__.easepick;
window.RangePlugin = _easepick_range_plugin__WEBPACK_IMPORTED_MODULE_4__.RangePlugin;
window.PresetPlugin = _easepick_preset_plugin__WEBPACK_IMPORTED_MODULE_5__.PresetPlugin; //initiate AplineJS
